...
@Schema(description = "Paginated order item response")
public class OrderItemPageResponseDto {

    @Schema(description = "Order items on the current page")
    private List<OrderItemDto> content;

    @Schema(description = "Total number of order items", example = "25")
